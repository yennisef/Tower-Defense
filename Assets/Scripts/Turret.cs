...
{
    // Turret Component
    [SerializeField] private SpriteRenderer _turretPlace;
    [SerializeField] private SpriteRenderer _turretHead;
    ...
    // Digunakan untuk menyimpan posisi yang akan ditempati selama Turret di drag
    ...
    // Mengubah order in layer pada Turret yang sedang di drag
    public void ToggleOrderInLayer (bool toFront)
    {
        int orderInLayer = toFront ? 2 : 0;
        _turretPlace.sortingOrder = orderInLayer;
        _turretHead.sortingOrder = orderInLayer;
    }

    // Fungsi yang digunakan untuk mengambil sprite pada Turret Head
    public Sprite GetTurretHeadIcon ()
    {
        return _turretHead.sprite;
    }
    ...
    public void ShootTarget ()
    {
        ...
        {
            bool headHasAimed = Mathf.Abs (_turretHead.transform.rotation.eulerAngles.z - _targetRotation.eulerAngles.z) < 10f;
            if (!headHasAimed)
            {
                return;
            }
    ...
    // Membuat Turret selalu melihat ke arah musuh
    public void SeekTarget ()
    {
        ...
        _turretHead.transform.rotation = Quaternion.RotateTowards (_turretHead.transform.rotation, _targetRotation, Time.deltaTime * 180f);
    }
}
